...
const LoginPage = () => {
  return (
    <div>
      ...
      <div className="absolute inset-0 top-44 w-4/12 mx-auto shadow-md shadow-teal-500 rounded">
      <form action="" className="w-9/12 mx-auto p-8 flex flex-col gap-6">
            <div>
                <legend className="text-xl mb-4">Email :</legend>
                <input type="email" className=" bg-transparent p-2 shadow-sm shadow-white" />
            </div>
            <div>
                <legend className="text-xl mb-4">Password :</legend>
                <input type="password" className=" bg-transparent p-2 shadow-sm shadow-white" />
            </div>
            ...
            <button className="border-b-2 rounded border-teal-500 transition duration-300 hover:bg-teal-600 py-2 text-lg shadow-sm shadow-teal-500">Login With Google</button>
        </form>
      </div>
    </div>
  )
