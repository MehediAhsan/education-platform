  ...
  return (
    <div>
      ...
      <main className="container mx-auto py-12">
        ...
        <section className="bg-gray-800 text-white py-16 rounded-lg text-center">
          <h2 className="text-3xl font-semibold mb-8">Why Choose EduConnect?</h2>
          <div className="flex flex-wrap justify-center space-y-4 md:space-y-0 md:space-x-8">
            <div className="flex items-center">
              <img src="/icon-1.svg" alt="Expert Instructors" className="w-12 h-12 mr-4" />
              <div>
                <h3 className="text-xl font-semibold">Expert Instructors</h3>
                <p className="text-gray-300">
                  Learn from industry experts and experienced educators in your field of interest.
                </p>
              </div>
            </div>
            <div className="flex items-center">
              <img src="/icon-2.svg" alt="Interactive Learning" className="w-12 h-12 mr-4" />
              <div>
                <h3 className="text-xl font-semibold">Interactive Learning</h3>
                <p className="text-gray-300">
                  Engage in interactive quizzes, assignments, and discussions to reinforce your learning.
                </p>
              </div>
            </div>
            <div className="flex items-center">
              <img src="/icon-3.svg" alt="Flexible Schedule" className="w-12 h-12 mr-4" />
              <div>
                <h3 className="text-xl font-semibold">Flexible Schedule</h3>
                <p className="text-gray-300">
                  Learn at your own pace with our on-demand courses, fitting your busy lifestyle.
                </p>
              </div>
            </div>
            {/* ... Add more features ... */}
